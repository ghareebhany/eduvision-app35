              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(children: [
                    ...
                    Expanded(
                      child: isLoading
                          // Fix: لا يمكن استخدام const هنا بعد ربط الألوان بالثيم
                          // (AppPalette.onHeaderMuted(context) دالة وقت تشغيل).
                          ? SizedBox(
                              height: 14,
                              child: Center(
                                child: SizedBox(
                                  ...
                                  child: LinearProgressIndicator(
                                    backgroundColor: AppPalette.onHeaderMuted(
                                            context)
                                        .withValues(alpha: 0.25),
                                    valueColor:
                                        AlwaysStoppedAnimation<Color>(
                                            AppPalette.onHeaderMuted(context)),
                                  ),
                                ),
                              ),
                            )
                          : (user != null)
                              ? Column(
                                  ...
                                  children: [
                                      // Fix: كانت نصوص الهيدر بيضاء ثابتة فاختفت
                                      // فوق الشريط الفاتح. الآن تتبع الثيم.
                                      Text('${_greeting()} 👋',
                                          style: TextStyle(
                                              color: AppPalette.onHeaderMuted(
                                                  context),
                                              fontSize: 11,
                  ...
                  Align(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        color: AppPalette.coralOf(context)
...
class _HdrBtn extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    // Fix: كانت أزرار الهيدر بيضاء شفافة فاختفت فوق الشريط الفاتح.
    // الآن تتبع الثيم: بيضاء في الغامق، وداكنة واضحة في الفاتح.
    final isDark = AppPalette.isDark(context);
    final fg = AppPalette.onHeader(context);
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(
              color: isDark
                  ...
                  : AppPalette.onHeader(context).withValues(alpha: 0.22)),
        ),
        child: AnimatedSwitcher(
          ...
          child: Icon(
            ...
            color: isDark ? AppPalette.peach : AppPalette.onHeader(context),
            size: 18,
          ),
        ),
      ),
