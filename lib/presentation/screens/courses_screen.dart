...
class _CoursesScreenState extends ConsumerState<CoursesScreen>
  ...
  List<Bundle> _apply(List<Bundle> all) {
    ...
    // بحث ذكي: يشمل اسم الباقة + وصفها + أسماء المعلمين + عناوين دروسها،
    // مع تطبيع الهمزات/التاء المربوطة/التشكيل ودعم عدة كلمات غير متتالية.
    final tokens = searchTokens(_q);
    if (tokens.isNotEmpty) {
      r = r.where((b) => matchesAllTokens(tokens, [
            b.title,
            b.description,
            b.instructors.join(' '),
    ...
    if (_sort == _Sort.enrolled) {
      ...
      // ترتيب حسب قوة المطابقة عند وجود بحث
      r = [...r]..sort((a, b) => _score(tokens, b).compareTo(_score(tokens, a)));
    }
    return r;
  }

  int _score(List<String> tokens, Bundle b) => relevanceScore(
        tokens: tokens,
        title: b.title,
        instructor: b.instructors.join(' '),
        extra: [b.description, b.courses.map((c) => c.title).join(' ')],
      );
                        ...
                        child: Container(
                          ...
                          child: TextField(
                            ...
                            decoration: InputDecoration(
                              hintText: 'ابحث باسم الباقة أو المعلم أو الدرس...',
                              hintStyle: TextStyle(
            ...
            children: [
              ...
              AspectRatio(
                ...
                child: Stack(fit: StackFit.expand, children: [
                  // الصورة تظهر كاملة دون قصّ (contain) فوق خلفية محايدة
                  Container(color: isDark ? AppTheme.mocha800 : AppTheme.mocha50),
